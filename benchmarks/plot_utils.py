...
def plot_read_write_benchmarks(rw_non_secure, rw_secure, exp_res_path, int_lat):
    ...
    read_throughput = read_throughput.replace("Secure", "IronBus")
    ...
    write_throughput = write_throughput.replace("Secure", "IronBus")
...
def plot_linux_baseline(LINUX_SYSCALL, m3_syscall_no_op, thai_syscall_no_op,
    ...
    syscall_dict = {}
    syscall_dict["System"] = ["Linux", "M\u00b3", "IronBus"]
    ...
    read_dict = {}
    read_dict["System"] = ["Linux", "M\u00b3", "IronBus"]
    ...
    write_dict["System"] = ["Linux", "M\u00b3", "IronBus"]
